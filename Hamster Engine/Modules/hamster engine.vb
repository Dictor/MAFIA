...
Public Class Engine
    Public Shared Version As New HamsterVersion("Hamster Engine", 1, 0, 140801, 0)
    Public Shared ProjVersion As New HamsterVersion("", 0, 0, 140000, 0) '이 부분을 수정하여 프로젝트 버젼을 수정하세요
    ...
    Public Shared Function RemoveNullArray(source As Object()) As Object()
        Dim i As Integer
        ...
        i = 0
        Dim RemovedData(NotnullDataAmount) As Object
    ...
    Public Shared Function CallFunction(funcname As String, params As Object()) As HamsterReturn
        Dim mi As MethodInfo = Console.[GetType]().GetMethod(funcname)
        mi.Invoke(Console, params)
    End Function
